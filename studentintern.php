                ...
                ?>   
                    <tr>
                        ...
                        <td> 
                            ...
                            <input class="form-control" type="text" name="rmarks" placeholder="HD" style="width: 50px;"> 
                        ...
                        <input type="hidden" name="sid" id="sid" value="<?php echo $row["studentid"]  ; ?>">
                        <input type="hidden" name="iid" id="iid" value="<?php echo $row["internshipid"]  ; ?>">  
