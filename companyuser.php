                ...
                <div class="login-wrap">
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            <h3>
                                <center>Company User Login</center>
                            </h3>
                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                <div class="form-group">
                                    <label>Company User ID</label>
                                    <input class="au-input au-input--full" type="number" name="companyuserid" placeholder="12345678" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="email" name="username" placeholder="name@example.com" required>
                                ...
                                <button class="au-btn au-btn--block au-btn--green m-b-20" action="#" type="submit">Sign Up</button>

                            </form>
                            <div class="register-link">
                                <p>
                                    Do you have account?
                                    <a href="companyprofile.php">Sign In Here</a>
                                </p>
                            </div>
